...
const bindings: Array<{ keys: string[]; desc: string }> = [
  ...
  { keys: ['j', 'k'], desc: 'Stack view: next / previous file' },
  { keys: [']', '['], desc: 'Stack view: next / previous group' },
  { keys: ['Enter'], desc: 'Stack view: expand / collapse the focused file' },
  { keys: ['o'], desc: 'Stack view: open the focused file in the classic diff' },
  { keys: ['Esc'], desc: 'Stack view: back to classic diff' },
